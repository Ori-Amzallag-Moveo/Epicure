...
export const chefsData: Chef[] = [
  {
    ...
    restaurants: [
      ...
      { name: 'Mashya', imgSrc: 'assets/restaurants/onza.jpg' }
    ]
  },
  {
    name: 'Eyal Shani',
    ...
    restaurants: [
      { name: 'HaSalon', imgSrc: 'assets/restaurants/hasalon.jpg' },
      { name: 'Port Said', imgSrc: 'assets/restaurants/port-said.jpg' },
